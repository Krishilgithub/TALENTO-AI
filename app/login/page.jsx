						...
						<div>
							...
							<div className="relative">
								...
								<button
									...
									className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-300 focus:outline-none cursor-pointer transition-colors duration-200"
									tabIndex={-1}
						...
						<div className="flex items-center justify-between space-x-4">
							<div className="flex items-center space-x-3 cursor-pointer select-none">
								<input
									...
									className="h-5 w-5 text-cyan-400 focus:ring-2 focus:ring-cyan-400 focus:ring-offset-2 focus:ring-offset-[#18191b] border-gray-600 rounded bg-[#101113] cursor-pointer"
								/>
								<label
									htmlFor="remember-me"
									className="block text-sm text-gray-300 cursor-pointer hover:text-gray-200 transition-colors duration-200"
								>
									Remember me
								</label>
							</div>
