				...
				{React.Children.toArray([
					...
					<div className="bg-[#18191b] rounded-xl shadow p-6 flex flex-col gap-2 hover:bg-[#232425] transition cursor-pointer">
						...
						<p className="text-gray-400 text-sm">
							...
							regional accent and dialect support, breaking down language barriers
							with AI-powered communication. Talento AI ensures you can
							communicate confidently in any global interview scenario.
						</p>
					</div>
					</motion.div>,
					<motion.div
					...
					<div className="bg-[#18191b] rounded-xl shadow p-6 flex flex-col gap-2 hover:bg-[#232425] transition cursor-pointer">
						...
						<p className="text-gray-400 text-sm">
							...
							used by most platforms, Talento AI delivers unmatched results.
						</p>
					</div>
					</motion.div>,
					<motion.div
					...
					<div className="bg-[#18191b] rounded-xl shadow p-6 flex flex-col gap-2 hover:bg-[#232425] transition cursor-pointer">
						...
						<p className="text-gray-400 text-sm">
							80% of our subscribers secure their dream jobs within 3 months, with
							40% landing $100K+ offers. Your success is our guarantee. Talento
							AI's proven track record speaks for itself, with thousands of
					...
					<div className="bg-[#18191b] rounded-xl shadow p-6 flex flex-col gap-2 hover:bg-[#232425] transition cursor-pointer">
						...
						<p className="text-gray-400 text-sm">
							...
							jobs, ace your interviews, and tap into expert communities to excel
							at every stage. Talento AI is your all-in-one career launchpad.
						</p>
					</div>
					</motion.div>,
					<motion.div
						...
						whileInView={{ opacity: 1, y: 0 }}
						viewport={{ once: true, amount: 0.3 }}
						transition={{ duration: 1, delay: 4 * 0.15, type: "spring", bounce: 0.2 }}
					>{/* Card 5 */}
					<div className="bg-[#18191b] rounded-xl shadow p-6 flex flex-col gap-2 hover:bg-[#232425] transition cursor-pointer">
						<span className="text-xs font-semibold text-cyan-400 bg-cyan-900/30 px-2 py-1 rounded w-fit mb-2">
							Mobile Optimized
						...
						<p className="text-gray-400 text-sm">
							...
							mobile-optimized platform. Talento AI is always with you, on any
							device.
						</p>
					</div>
					</motion.div>,
					<motion.div
						...
						whileInView={{ opacity: 1, y: 0 }}
						viewport={{ once: true, amount: 0.3 }}
						transition={{ duration: 1, delay: 5 * 0.15, type: "spring", bounce: 0.2 }}
					>{/* Card 6 */}
					<div className="bg-[#18191b] rounded-xl shadow p-6 flex flex-col gap-2 hover:bg-[#232425] transition cursor-pointer">
						<span className="text-xs font-semibold text-cyan-400 bg-cyan-900/30 px-2 py-1 rounded w-fit mb-2">
						...
						<p className="text-gray-400 text-sm">
							...
							instant corrections. Talento AI's technology ensures you are always
							interview-ready.
						</p>
					</div>
					</motion.div>,
