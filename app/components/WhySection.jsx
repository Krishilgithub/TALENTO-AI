			...
			<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
				{React.Children.toArray([
					React.cloneElement(
						...
						>
							{/* Card 1 */}
							<div className="bg-white dark:bg-[#18191b] border border-gray-200 dark:border-gray-800 rounded-xl shadow p-6 flex flex-col gap-2 hover:bg-gray-50 dark:hover:bg-[#232425] transition cursor-pointer">
								<span className="text-xs font-semibold text-cyan-400 bg-cyan-900/30 px-2 py-1 rounded w-fit mb-2">
									Speech Recognition
								</span>
								<h3 className="text-lg font-bold text-gray-900 dark:text-white">Multilingual</h3>
					...
					React.cloneElement(
						...
						>
							...
							<div className="bg-white dark:bg-[#18191b] border border-gray-200 dark:border-gray-800 rounded-xl shadow p-6 flex flex-col gap-2 hover:bg-gray-50 dark:hover:bg-[#232425] transition cursor-pointer">
								...
								<h3 className="text-lg font-bold text-gray-900 dark:text-white">Advanced AI Models</h3>
								<p className="text-gray-600 dark:text-gray-400 text-sm">
					...
					React.cloneElement(
						...
						>
							...
							<div className="bg-white dark:bg-[#18191b] border border-gray-200 dark:border-gray-800 rounded-xl shadow p-6 flex flex-col gap-2 hover:bg-gray-50 dark:hover:bg-[#232425] transition cursor-pointer">
								...
								<h3 className="text-lg font-bold text-gray-900 dark:text-white">Proven Success Rate</h3>
								<p className="text-gray-600 dark:text-gray-400 text-sm">
					...
					React.cloneElement(
						...
						>
							...
							<div className="bg-white dark:bg-[#18191b] border border-gray-200 dark:border-gray-800 rounded-xl shadow p-6 flex flex-col gap-2 hover:bg-gray-50 dark:hover:bg-[#232425] transition cursor-pointer">
								...
								<h3 className="text-lg font-bold text-gray-900 dark:text-white">Complete Career Ecosystem</h3>
								<p className="text-gray-600 dark:text-gray-400 text-sm">
					...
					React.cloneElement(
						...
						>
							...
							<div className="bg-white dark:bg-[#18191b] border border-gray-200 dark:border-gray-800 rounded-xl shadow p-6 flex flex-col gap-2 hover:bg-gray-50 dark:hover:bg-[#232425] transition cursor-pointer">
								...
								<h3 className="text-lg font-bold text-gray-900 dark:text-white">Practice Anywhere</h3>
								<p className="text-gray-600 dark:text-gray-400 text-sm">
					...
					React.cloneElement(
						...
						>
							...
							<div className="bg-white dark:bg-[#18191b] border border-gray-200 dark:border-gray-800 rounded-xl shadow p-6 flex flex-col gap-2 hover:bg-gray-50 dark:hover:bg-[#232425] transition cursor-pointer">
								...
								<h3 className="text-lg font-bold text-gray-900 dark:text-white">Dual-Layer AI Platform</h3>
								<p className="text-gray-600 dark:text-gray-400 text-sm">
