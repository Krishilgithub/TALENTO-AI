	...
	return (
		<div className="min-h-screen flex flex-col items-center justify-center bg-[#101113] py-12 px-4">
			...
			<p className="text-lg text-gray-300 mb-8 text-center max-w-2xl">
				Plan your career with confidence! Follow the steps below to discover your strengths, explore opportunities, set goals, and track your progress.
			</p>
				...
				{CAREER_STEPS.map((step) => (
					...
					>
						...
						<div className="flex-1">
							<h2 className="text-xl font-semibold text-cyan-400 mb-1">{step.title}</h2>
			...
			<div className="w-full max-w-3xl mb-12">
				<h3 className="text-lg font-semibold text-yellow-400 mb-2">Popular Career Paths</h3>
			...
			<div className="w-full max-w-3xl">
				<h3 className="text-lg font-semibold text-gray-200 mb-2">Resources & Next Steps</h3>
				<ul className="list-disc list-inside text-gray-400">
					<li>Take relevant assessments to identify your strengths and areas for growth.</li>
