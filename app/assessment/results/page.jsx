								...
								<div className="space-y-6">
									{results.questions.map((item, index) => (
										<motion.div
											...
											className={`border rounded-xl p-6 transition-all duration-200 ${item.isCorrect
										...
										>
											<div className="flex items-start justify-between mb-4">
												<div className="flex items-center">
													<div className={`w-8 h-8 rounded-full flex items-center justify-center mr-3 ${item.isCorrect ? 'bg-green-500' : 'bg-red-500'
														}`}>
														{item.isCorrect ? (
													...
													<div className="grid gap-2 mb-4">
														{item.questionOptions.map((option, optIndex) => {
															...
															return (
																<div
																	key={optIndex}
																	className={`p-3 rounded-lg border text-sm transition-all ${isCorrectAnswer
