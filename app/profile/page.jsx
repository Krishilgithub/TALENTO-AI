...
export default function ProfilePage() {
  ...
  const handleSave = withLoadingCursor(async (field) => {
    setError('');
    setSuccess('');

    let updates = {};
    if (field === 'name') {
      updates = { data: { name: form.name } };
    } else if (field === 'email') {
  ...
  const handlePhotoUpload = withLoadingCursor(async (e) => {
    ...
    try {
      ...
      const { error: authError } = await updateUser({ data: { avatar_url: publicUrlData.publicUrl } });
      ...
      // Try to update users table, but don't fail if RLS blocks it
      try {
        ...
        console.log('RLS policy prevented users table update, but auth metadata updated successfully');
      }
  ...
  const handleLogout = withLoadingCursor(async () => {
    await signOut();
    router.push('/login');
  });
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-slate-900 to-black py-8 px-4 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="flex items-center justify-between mb-12">
          <div className="flex items-center space-x-6">
            <button
              ...
              className="group p-4 rounded-2xl bg-gray-800/40 backdrop-blur-xl border border-gray-700/50 text-gray-400 hover:text-white hover:bg-gray-700/40 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-cyan-500/25"
            >
          ...
          <div className="flex items-center space-x-4">
            <button
              ...
              className="group px-6 py-3 bg-gray-800/40 backdrop-blur-xl border border-gray-700/50 text-gray-300 rounded-xl hover:bg-gray-700/40 hover:text-white transition-all duration-300 hover:scale-105 hover:shadow-lg flex items-center space-x-2"
            >
            ...
            <button
              ...
              className="group flex items-center space-x-3 px-8 py-4 bg-gradient-to-r from-red-600 to-red-700 text-white rounded-2xl hover:from-red-700 hover:to-red-800 transition-all duration-300 shadow-xl shadow-red-500/25 hover:scale-105 hover:shadow-2xl hover:shadow-red-500/40"
            >
                    ...
                    <div className="w-full h-full rounded-full overflow-hidden bg-gray-800 flex items-center justify-center relative">
                      {profileImageUrl && !imageError ? (
                        <Image
                          ...
                          width={176}
                          height={176}
                          className="w-full h-full object-cover rounded-full transition-all duration-500 group-hover/avatar:scale-110"
        ...
        <div className="mt-12 flex flex-wrap justify-center gap-6">
          <button className="group flex items-center space-x-3 px-8 py-4 bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 text-white rounded-2xl transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-cyan-500/40 border-2 border-cyan-400/20">
            <FiEdit2 className="w-5 h-5 group-hover:rotate-12 transition-transform duration-300" />
            <span className="font-bold">Edit Profile</span>
          </button>

          <button className="group flex items-center space-x-3 px-8 py-4 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-500 hover:to-pink-500 text-white rounded-2xl transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-purple-500/40 border-2 border-purple-400/20">
          ...
          <button className="group flex items-center space-x-3 px-8 py-4 bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 text-white rounded-2xl transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-emerald-500/40 border-2 border-emerald-400/20">
